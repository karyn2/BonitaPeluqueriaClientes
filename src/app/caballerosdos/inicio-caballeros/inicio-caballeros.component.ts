...
@Component({
  selector: 'app-inicio-caballeros',
  templateUrl: './inicio-caballeros.component.html',
  styleUrls: ['./inicio-caballeros.component.css']
})
export class InicioCaballerosComponent {
  redireccionarAMaps() {
